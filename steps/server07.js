// You should be able to se the page in the browser when access localhost:3000
...
// The fist thing we should do is to import the http built in node module
// to extract the server from the app instance

// Use the require syntax to import the http and call
